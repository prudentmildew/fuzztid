...
| [0029](./0029-the-mark-three-arched-columns-crossed.md) | The mark: three arched columns crossed by the Now line — the three Stages, a church window and the Now line at once, in four of the palette's six tokens; `favicon.svg` is the source and the five PNGs are renders of it |
